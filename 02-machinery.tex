...
We will need to use the Lorentzian splitting theorem ((REF beem)):
...
For the next proposition we again endow $M$ a metric $d$ which is induced by $g^+$. This allows us to define open balls.
