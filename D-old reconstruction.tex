...
The next proposition allows us to endow $U$ with a number of \enquote{laboratory frames} which we will use to conveniently describe the light cone observations on $U$.
